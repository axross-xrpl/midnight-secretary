...
5. MST で各代行AIのウォレットに支払い、代行AIが **オンチェーン着金を確認してから** 予約確定
...
- 食事の好み: 中華料理
- 趣味: アート観賞、野球観戦
- ウォレット: 3口座（秘書/交通業者/サービス業者）。MST とガスに使う NIGHT/DUST はfaucetで準備。秘書へMST付与
...
| 6 | サマリー最終確認 | スケジュール全体と合計MSTを提示 | 承認 |
...
| SCR-04a | 設定画面。プロフィール設定 | 氏名、住所、生年月日、居住都道府県。拠点（出発都市・起点）。好み・予算・優先度。ウォレットアドレス（SCR-04cができるまでの暫定） |
